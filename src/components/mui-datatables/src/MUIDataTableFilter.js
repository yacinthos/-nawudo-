            ...
            column.filter ? (
                <FormControl className={classes.selectFormControl} key={index}>
                    <SelectInput
                        ...
                        optionsLoader={
                            ()=>{
                                return new Promise(resolve => {
                                    const options=filterData[index].map(
                                        (item)=>{
                        ...
                        key={index + 1}
                        label={column.name}
                        onChange={value => this.handleMultiselectChange(index,value)}
                        onBlur={value => this.handleMultiselectChange(index,value)}
                        onFocus={value => this.handleMultiselectChange(index,value)}
